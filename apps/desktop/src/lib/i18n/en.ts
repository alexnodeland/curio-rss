...
export const en = {
    ...
    'reader.reddit.loadFull': 'Load full post',
    'reader.loadingFull': 'Loading…',
    ...
    'typography.hyphens': 'Hyphenate',
    'typography.readingTheme': 'Reading theme',
    'typography.readingTheme.default': 'Match app',
    'typography.readingTheme.sepia': 'Sepia',
    'typography.readingTheme.paper': 'Paper',
    ...
    'destinations.exportAll': 'Export all',
    'destinations.exportAll.running': 'Exporting…',
    'destinations.exportAll.done': 'Exported {written} note(s); {unchanged} already up to date',
    ...
    'addFeed.saveLink': 'Save to Read Later',
    'addFeed.savingLink': 'Saving…',
    'addFeed.linkSaved': 'Saved “{title}” to Read Later',
    'addFeed.linkSavedBare': 'Link saved — the page could not be fetched',
    ...
    'settings.redditApi.hint':
        'Optional. With your own free Reddit app, full posts load at ~100 requests/min instead of ~10. The secret is stored in the system keychain and never leaves this device except to Reddit.',
    'settings.redditApi.status.on': 'Connected — client id {clientId}',
    'settings.redditApi.status.off': 'Not connected — using the slower public endpoint',
    'settings.redditApi.clientId': 'Client id',
    'settings.redditApi.clientSecret': 'Client secret',
    'settings.redditApi.save': 'Save',
    'settings.redditApi.remove': 'Remove credentials',
    'settings.redditApi.saved': 'Reddit API credentials saved to the keychain',
    'settings.redditApi.removed': 'Reddit API credentials removed',
    'settings.redditApi.create': 'Create a free app at reddit.com/prefs/apps',
    ...
    'editFeed.fullText': 'Fetch full text',
    'editFeed.fullText.hint':
        'Load each new article’s web page and keep the extracted full text instead of the feed’s excerpt.',
