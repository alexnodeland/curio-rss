...
export const SETTING_KEYS = {
    ...
    fontWeight: 'ui.typography.font-weight',
    letterSpacing: 'ui.typography.letter-spacing',
    hyphenate: 'ui.typography.hyphenate',
    readingTheme: 'ui.typography.reading-theme',
