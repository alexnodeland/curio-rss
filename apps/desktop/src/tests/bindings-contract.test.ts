...
const cases: { [K in CommandName]: ContractCase<K> } = {
    ...
    setFeedMetadata: { args: [1, 'https://example.com', 'A note'], response: null },
    setFeedFullText: { args: [1, true], response: null },
    reorderFeeds: { args: [[3, 1, 2]], response: null },
    ...
    saveUrl: {
        args: ['https://example.org/essay', ['inbox']],
        response: { article: articleFixture(), created: true, hydrated: true },
    },
    ...
    promoteAll: {
        ...
        response: { created: 2, updated: 1, unchanged: 3 },
    },
    ...
    setRedditApi: {
        args: ['cid123', 'shh'],
        response: { configured: true, client_id: 'cid123' },
    },
    clearRedditApi: { args: [], response: { configured: false, client_id: null } },
    getRedditApiStatus: { args: [], response: { configured: false, client_id: null } },
